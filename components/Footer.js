...
const Footer = () => {
    return (
        <footer className="text-gray-100 relative bg-black -z-30 min-h-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 p-10">
                ...
                <div className="text-center md:text-left">
                    Say Hello!
                    <div className="flex justify-center md:justify-start gap-3 mt-3 -m-">
                ...
                <div className="">
                    <form action="\home" className="w-full max-w-sm md:ml-auto">
                        <div className="flex items-center mb-2">
                            <div className="w-1/2">
                                <label className="block text-gray-100 font-bold text-right mb-1 md:mb-0 pr-4" htmlFor="inline-full-name"> Name </label>
                            </div>
                            <div className="w-1/2">
                        ...
                        <div className="flex items-center mb-2">
                            <div className="w-1/2">
                                <label className="block text-gray-100 font-bold text-right mb-1 md:mb-0 pr-4" htmlFor="inline-password"> Email </label>
                            </div>
                            <div className="w-1/2">
                        ...
                        <div className="flex items-center mb-2">
                            <div className="w-1/2">
                                <label className="block text-gray-100 font-bold text-right mb-1 md:mb-0 pr-4" htmlFor="inline-password"> Organisation </label>
                            </div>
                            <div className="w-1/2">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="w-1/2">
                                <input className="ml-auto shadow bg-blue-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-1 px-3 rounded" type="button" value="Subscribe" />
                            </div>
                        </div>
                    </form>
                </div>
