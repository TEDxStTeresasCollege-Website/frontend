...
const Circles = () => {
    return (
        <>
            ...
            <div className="bg-gradient-to-t from-pink-300 via-pink-100 to-white relative">
                ...
                <div className='absolute right-32 w-56 h-66'>
                ...
                <div className="relative">
                    <div className='absolute -bottom-72 left-32 w-56 h-66'>
                ...
                <footer className="text-xs md:text-sm text-gray-100 relative min-h-screen w-full md:mt-0">
                    ...
                    <div className="absolute -z-20 top-0">
                        <img className="bg-contain mobile" src="circle/footerCircles.png" loading="eager"></img>
