    ...
    <div>
      ...
      <section id="vision" className="w-full min-h-screen">
        <div className="text-center font-sans text-black mt-36 mx-auto w-5/6 md:w-3/4 p-20">
          ...
          <h3 className="text-sm md:text-lg">When the Teresian spirit meets TED's ethos, mind blowing ideas erupt. </h3>
      ...
      <section id="whatIsTedX" className="w-full min-h-screen">
