  ...
  return (
    <div>
      ...
      <section id="about" className="w-full min-h-full relative">
        <div className="absolute h-full w-full -z-1"><Image className="relative" src="/mobile/home/secondbg.png" layout="fill" objectFit="fit" objectPosition='center' /></div>
      ...
      <section id="camera-roll" className="w-full min-h-full my-20">
        <div className="flex flex-col gap-5 items-center justify-center font-sans text-black min-h-full mx-auto w-full p-2 md:w-1/2">
          <h1 className="font-bold text-2xl md:text-5xl mb-5">Camera Roll</h1>
          <Slide />
        </div>
      </section>
