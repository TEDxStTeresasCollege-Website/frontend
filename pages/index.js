    ...
    <div>
      ...
      <section id="home" className="w-full h-screen relative">
        ...
        <div className="flex flex-col gap-5 text-center items-center justify-center font-sans text-white min-h-screen w-full">
          <p className="font-bold text-3xl sm:text-4xl md:text-5xl">Welcome to TEDxStTeresasCollege</p>
          <p className="text-xl sm:text-3xl">Where perceptions meets new perspectives</p>
        </div>
      </section>

      <section id="vision" className="w-full min-h-screen">
        <div className="flex flex-col justify-center items-center text-justify lg:text-center font-sans text-black h-screen mx-auto w-5/6 md:w-3/4 px-20 -mb-20">
          <h1 className="font-bold text-2xl md:text-3xl pb-10">Our Vision</h1>
          <h3 className="text-sm md:text-lg pb-5">When the Teresian spirit meets TED's ethos, mind blowing ideas erupt. </h3>
      ...
      <section id="about" className="w-full min-h-screen relative">
        ...
        <div className="flex flex-wrap md:gap-5 justify-center items-center w-5/6 md:w-3/4 min-h-screen mx-auto text-center text-gray-100 py-40">
          <div className=" bg-gray-800 p-6 rounded-lg shadow-lg m-2 bg-opacity-60 hover:bg-opactiy-100">
      ...
      <section id="camera-roll" className="w-full min-h-screen">
      ...
      <section id="whatIsTedX" className="w-full min-h-screen bg-black">
        {/* <div className="absolute h-full w-full -z-1 mobile">
          <Image className="relative " src="/mobile/home/secondbg.png" layout="fill" objectFit="fit" objectPosition='center' />
        </div>
        <div className="absolute h-full w-full -z-1 web">
