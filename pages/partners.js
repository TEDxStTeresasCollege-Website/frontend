...
const Partners = () => {
    return (
        <>
            ...
            <Navbar />
            <Background />
            <div className="flex flex-col gap-5 items-center text-center justify-center font-sans text-white sans mx-auto w-3/4 min-h-screen">
                <h1 className="font-bold text-2xl md:text-4xl serif text-ted-red">Our Partners</h1>
