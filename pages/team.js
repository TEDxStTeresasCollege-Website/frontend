...
const Team = () => {
    ...
    return (
        <>
            ...
            <div className="min-h-screen mb-20 border border-green-900">
                ...
                <div className="m-10 border border-black grid sm:grid-cols-1 lg:grid-cols-4 gap-5 w-3/4 mx-auto">
                    <TeamCard name="Neha" designation="Head" image="/member/technical/Neha Neenus.jpg" url="https://www.instagram.com/marianne_joseph_" />
                </div>
            </div>
