...
const about = () => {
    return (
        <div>
            ...
            <section className="w-full min-h-screen mt-20 text-white mx-auto relative">
                <Background />
                <div className="w-5/6 md:w-2/3 flex flex-col gap-5 mx-auto items-center justify-center text-center py-20">
                    ...
                    <h3 className="text-sm md:text-lg text-justify sans">Follow TED on <a className='hover:underline' href="http://twitter.com/TEDTalks">Twitter</a> or on <a className='hover:underline' href="http://www.facebook.com/TED">Facebook</a></h3>
                </div>
            </section>
